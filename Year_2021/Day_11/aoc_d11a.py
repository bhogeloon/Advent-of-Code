...
For each of the 100 steps, walk through the matrix and increase the value by
1. If the values exceeds 9, start the flash process, which means go to every
neighbor and increase the value of that neighbor. Each time, if the value
exceeds 9, start the flash process.
In order to prevent items flashing multiple times, keep a list of points which
already have flashed.
...
if __name__ == '__main__':
    ...
    print("Number of flashes:", get_nr_of_flashes(lines))
